...
return [
    ...
    */
    ...
    | users are retrieved from your database or other storage.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | You can specify multiple password reset configurations.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | How many seconds before the password confirmation expires.
    |
    */
